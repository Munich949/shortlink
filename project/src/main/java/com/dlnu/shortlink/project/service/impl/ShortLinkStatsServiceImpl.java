...
import com.dlnu.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        // 小时访问详情
        List<Integer> hourStats = CollUtil.newArrayList();
        ...
        // 地区访问详情（仅国内）
        List<ShortLinkStatsLocaleCNRespDTO> localeCnStats = CollUtil.newArrayList();
        List<LinkLocaleStatsDO> listLocaleByShortLink = linkLocaleStatsMapper.listLocaleByShortLink(requestParam);
        int localeSum = listLocaleByShortLink.stream()
        ...
        // 高频访问IP详情
        List<ShortLinkStatsTopIpRespDTO> topIpStats = CollUtil.newArrayList();
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        // 基础访问数据
        LinkAccessStatsDO pvUvUipStatsByShortGroup = linkAccessLogsMapper.findPvUvUipStatsByShortGroup(requestParam);
        // 基础访问详情
        List<ShortLinkStatsAccessDailyRespDTO> daily = new ArrayList<>();
        ...
        return ShortLinkStatsRespDTO.builder()
                .pv(pvUvUipStatsByShortGroup.getPv())
                .uv(pvUvUipStatsByShortGroup.getUv())
                .uip(pvUvUipStatsByShortGroup.getUip())
                .daily(daily)
                .hourStats(hourStats)
                .topIpStats(topIpStats)
                .weekdayStats(weekdayStats)
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        ...
        IPage<ShortLinkStatsAccessRecordRespDTO> actualResult = linkAccessLogsPage.convert(each -> BeanUtil.toBean(each, ShortLinkStatsAccessRecordRespDTO.class));
